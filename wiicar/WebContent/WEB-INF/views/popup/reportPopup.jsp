...
<script>
   $(document).ready(function(){
      ...
      $("#reportBtn").click(function(){
         ...
         $.ajax({
            url: '/wiicar/carpool/reportUser.do',
            type: 'POST',
            data: {reportid: '${sessionScope.sid}', id: '${opponent}', content : $("#reportContent").val()},
...
<div class="container" style="padding-top:20px">
   ...
   <div class="row mb-3">
      ...
      <div class="col-sm-6">${opponent}</div>
   </div>
   <div class="row mb-3">
   ...
   <div class="row mb-3">
      <div class="col-sm-12">신고 사유</div>
   </div>
   <div align="center">
      <textarea id="reportContent" cols="70" rows="10"></textarea>   
   </div>
   <div class="row mb-3">
