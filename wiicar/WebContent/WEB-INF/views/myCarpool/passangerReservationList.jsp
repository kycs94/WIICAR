	 		...
	 		<div class="mypageContent">
    			...
    			<div class="content">
					...
					<div class="carpool_list">
						<div class="list_btn">
			          		<button class="waiting" onclick="location.href='/wiicar/member/passangerMyCarpool.do?sort=reservation'">매칭 대기중</button>
	          				<button class="schedule" onclick="location.href='/wiicar/member/passangerMyCarpool.do?sort=upcomming'">예정된 카풀</button>
	          				<button class="past"onclick="location.href='/wiicar/member/passangerMyCarpool.do?sort=past'">지난 카풀</button>
						</div>
						<div>
									...
									<div style="margin:auto;width:600px;background-color:#ffffff;border-radius:10px;box-shadow:5px 5px 1px 1px gray;">
										<div style="padding-top:20px;">
											...
											<div style="display:flex;margin-left:20px;margin-top:10px;">
												...
												<c:if test="${reservationList[i].acceptance == 0}">
													<div style="margin-right:20px;margin-left:auto;">
														<button class="requestBtn"  style="border:none;border-radius:5px;width:120px;height:30px;color:white;background-color:grey;" value="${i}">예약요청중</button>
														<button class="requestBtn"  style="border:none;border-radius:5px;width:120px;height:30px;color:white;background-color:red;" value="${i}">예약취소</button>
													</div> 
												</c:if>
												<c:if test="${reservationList[i].acceptance == 2}">
													<div style="margin-right:20px;margin-left:auto;">
														<button class="requestBtn"  style="border:none;border-radius:5px;width:120px;height:30px;color:white;background-color:red" value="${i}">거절</button>
													</div> 
												</c:if>
											</div>
