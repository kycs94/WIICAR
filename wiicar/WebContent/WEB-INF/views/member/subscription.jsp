...
<script>
	$(document).ready(function() {
		console.log("subscription = ${sessionScope.subscription}");
		...
		<div id="mypage">
			<div class="row1">
				<div class="mypageContent">
					<div class="content">
						<div class="subscriptionHeader" style="line-height: 100%;">
						...
						<div>
							<div style="width:300px;margin:auto;font-size:30px;text-align: initial;line-height: 100%;">
