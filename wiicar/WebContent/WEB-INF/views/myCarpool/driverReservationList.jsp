										...
										<div style="padding-top:20px;">
											...
											<div style="display:flex;margin-left:20px;margin-top:10px;">
												<div style="margin-right:20px;margin-left:auto;">
														...
														<button id="accept" class="requestBtn" onclick="btn('accept');" style="border:none;border-radius:5px;width:120px;height:30px;color:white;background-color:#3498DB;" >수락</button>
														<button id="refuse" class="requestBtn" onclick="btn('refuse');" style="border:none;border-radius:5px;width:120px;height:30px;color:white;background-color:#3498DB;" >거절</button>
													</div> 
											</div>
