												...
												<div style="margin-right:20px;margin-left:auto;">
													<c:if test="${reviewCheck[i] == 0}">
														<button class="reviewBtn"
														 style="border:none;border-radius:5px;width:120px;height:30px;color:white;background-color:orange;" value1="${carpoolList[i].driverId}" value2="${carpoolList[i].carpoolNum}">리뷰 작성</button>
													</c:if>
													<c:if test="${reviewCheck[i] != 0}">
														<button class="reviewBtn"
														 style="border:none;border-radius:5px;width:120px;height:30px;color:white;background-color:gray;pointer-events: none;" value1="${carpoolList[i].driverId}" value2="${carpoolList[i].carpoolNum}">리뷰 완료</button>
													</c:if>
												</div> 
											</div>
