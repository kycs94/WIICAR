		...
		<div id="content">
			<div style="width:100%;max-width:1400px;margin:auto;">
				...
				<!--  검색바 -->
					...
					<div style="margin:auto;width:70%;text-align:right;display:flex;">
						<div class="btn-group" style="margin-left:auto;margin-right:0px;">
							<button id="sortBtn" type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-expanded="false" style="width:130px;margin-right:15px;margin-left:auto;">정렬 기준&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="caret"></span></button>
							<ul id="sortDropdown" class="dropdown-menu" role="menu" style="">
							...
							<nav>
								<ul class="pagination" style="display:flex;justify-content:center;align-items:center;">
									<c:if test="${startPage > pageBlock}">
										<li><a href="/wiicar/carpool/carpoolList.do?pageNum=${startPage-pageBlock}&orderby=${orderby}" aria-label="Previous">
									...
									<c:if test="${endPage < pageCount }">
										<li><a href="/wiicar/carpool/carpoolList.do?pageNum=${startPage+pageBlock}&orderby=${orderby}" aria-label="Next">
											<span aria-hidden="true">&gt;</span>
										</a></li>
									</c:if>
								</ul>
