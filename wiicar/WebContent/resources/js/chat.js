...
//          carpoolRes(chatId, carpoolnum, driverRate, passengerRate);
         ...
         html += "<span id=\"reportBtn\" onclick=\"reportUser(\'"+data.nickname+"\');\">신고하기</span>";
         $('.user-wrap').empty();
...
function notiDisplayTest() {
	$.ajax({
		...
		success : function(data) {
			 ...
			 html+="<input class='carpoolnum' name='carpoolnum' type='hidden' value='"+dat.alertList[i].carpoolnum+"'>"
