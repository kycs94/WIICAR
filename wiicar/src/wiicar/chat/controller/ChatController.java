...
import wiicar.chat.dto.ChatReportDTO;
...
//		MatchingDTO reserveInfo = chatService.getReserve(chatId, userId);
	...
	public int chatRoomDelete(@RequestBody Map<Object, Object> map) throws SQLException{
		String userId = (String)map.get("nickname");
		String roomnum = (String)map.get("roomnum");
	...
	public String reportPopup(String nickname, Model model) {
	 ...
	 // 신고 처리
	   ...
	   public ResponseEntity<Integer> reportUser(ChatReportDTO dto) throws SQLException {
	      HttpHeaders respHeaders = new HttpHeaders();
	      respHeaders.add("Content-type", "test/html;charset=utf-8");
	      return new ResponseEntity<Integer>(chatService.reportUser(dto), respHeaders, HttpStatus.OK); 
	   }
